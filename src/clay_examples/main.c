...
int main(void) {
    ...
    Font fonts[2];
    fonts[FONT_ID_BODY_24] = LoadFontEx("D:\\Coding\\dsp-project-refactor\\src\\clay_examples\\resources\\Roboto-Regular.ttf", 48, 0, 400);
	SetTextureFilter(fonts[FONT_ID_BODY_24].texture, TEXTURE_FILTER_BILINEAR);
    fonts[FONT_ID_BODY_16] = LoadFontEx("D:\\Coding\\dsp-project-refactor\\src\\clay_examples\\resources\\Roboto-Regular.ttf", 32, 0, 400);
